...
mapping = {
    ...
    "H8599": {"translit": "tappûaḥ", "translitKo": "타푸아흐", "note": "관용 표기는 답부아, furtive patach"},
    ...
    "H851": {"translit": "ʾeštĕmōaʿ", "translitKo": "에쉬테모아", "note": "관용 표기는 에스드모아, furtive patach"},
    "H8480": {"translit": "taḥat", "translitKo": "타하트", "note": "관용 표기는 다핫"},
    "H4494": {"translit": "mānôaḥ", "translitKo": "마노아흐", "note": "관용 표기는 마노아, furtive patach"},
...
for entry in out_data["entries"]:
    s_id = entry["strong"]
    if s_id in mapping:
        entry["translit"] = mapping[s_id]["translit"]
        entry["translitKo"] = mapping[s_id]["translitKo"]
        entry["note"] = mapping[s_id]["note"]
    else:
        print(f"Missing {s_id}")
