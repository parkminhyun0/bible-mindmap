...
// Mapping from WORKER_SPEC / scratch_translit script
const mapping = {
...
for (const item of data.items) {
  ...
  if (mapping[strong]) {
    ...
    // Use provided translit for Hebrew if present, otherwise mapping may contain translit for Greek (none in mapping)
