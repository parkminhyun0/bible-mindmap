...
const emitVersionJson = () => ({
  ...
  writeBundle(options) {
    ...
    const payload = {
      ...
      appBase: APP_BASE,
      deployment: IS_VERCEL ? 'vercel' : 'github-pages',
    }
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          },
          {
            ...
            urlPattern: STRONGS_URL_PATTERN,
            handler: 'CacheFirst',
            options: {
