...
assert(s.verses === 1151, `expected 1151 verses, got ${s.verses}`);
...
assert(Math.abs(s.tokenCountDeltaTagntMinusMorphgnt) <= 25, `token delta too large: ${s.tokenCountDeltaTagntMinusMorphgnt}`);
