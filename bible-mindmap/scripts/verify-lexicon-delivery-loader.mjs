...
console.log('✓ P4 read-only Approval Registry public delivery/loader PASS');
console.log('  H0776→H776 · approved senses 26/26 · one lazy shard · unapproved Strong fail-closed');
console.log('  loader transport: same-origin GET-only · service/UI integration: not enabled in this contract');
