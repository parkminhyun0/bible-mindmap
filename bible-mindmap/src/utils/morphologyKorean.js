...
const NOTES = {
  ...
  '칼(Qal)':'기본 능동 의미를 나타내는 가장 일반적인 히브리어 동사 어간입니다.',
  '니팔(Niphal)':'주로 수동·중간 또는 재귀 의미를 나타낼 수 있습니다.',
  '피엘(Piel)':'강조·집중·반복 의미를 나타낼 수 있습니다.',
  '히필(Hiphil)':'주로 사역 의미, 곧 어떤 행동을 하게 함을 나타냅니다.',
  '히트파엘(Hithpael)':'주로 재귀·상호 또는 자기 관련 동작을 나타냅니다.',
...
export function explainMorphologyKorean(code) {
  ...
  return {
    ...
    caution: '형태론은 가능한 문법 기능을 보여 줍니다. 최종 의미는 문장 구조와 문맥을 함께 확인해야 합니다.',
  };
}
