          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
                ...
                <span style={{ fontSize: 9, fontWeight: 900, color: map.precision === 'curated' ? '#7c3aed' : '#1d4ed8', background: map.precision === 'curated' ? '#f3e8ff' : '#dbeafe', padding: '2px 6px', borderRadius: 99 }}>{precisionLabel}</span>
              </div>
      ...
      <div style={{ flex: 1, minHeight: 0, overflowY: 'auto', WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain', touchAction: 'pan-y' }}>
        <div style={{ padding: isMobile ? '12px 14px calc(env(safe-area-inset-bottom, 0px) + 28px)' : '8px 10px 10px' }}>
          {map.precision !== 'curated' && (
            <div style={{ marginBottom: 10, padding: '9px 10px', borderRadius: 10, background: '#fff7ed', color: '#9a3412', fontSize: isMobile ? 10.5 : 9.5, lineHeight: 1.5 }}>
                ...
                <div style={{ marginBottom: isMobile ? 10 : 0 }}>
                  ...
                  {isOpen && (
                    <div style={{ marginTop: 7, padding: isMobile ? '10px' : '9px 10px', borderRadius: 11, background: '#fff', border: '1px solid rgba(15,23,42,.08)' }}>
                      ...
                      <Info title="구조적 의미" text={rel.meaning} color="#7c3aed" bg="#f5f3ff" isMobile={isMobile} />
