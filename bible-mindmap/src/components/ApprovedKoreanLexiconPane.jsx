      ...
      {loading && (
        <div
          ...
          style={{
            ...
            color: '#94a3b8', fontSize: 12, WebkitOverflowScrolling: 'touch',
      ...
      {!loading && !approvedEntry && (
        ...
        >
          <div style={{
            ...
            border: '1px solid #e2e8f0', color: '#64748b', fontSize: 12, lineHeight: 1.65,
          }}>
            {failed
      ...
      {approvedEntry && (
        <>
          <div style={{
            ...
            background: '#fef3c7', borderBottom: '1px solid #fde68a', flexShrink: 0,
          }}>
          ...
          <div style={{
            ...
            color: '#a16207', fontSize: 9, lineHeight: 1.5, flexShrink: 0,
          }}>
