...
const SECTIONS = [
  ...
  },
  {
    ...
    content: [
      {
        type: 'desc',
        text: '화면 오른쪽 끝 "✍️ 문서 작성" 세로 탭을 클릭하면 문서 작성 패널이 열립니다. 설교 초안이나 아이디어를 마크다운으로 작성하고, 저장소에 저장해 언제든 다시 불러올 수 있습니다.',
      },
      {
        type: 'list',
        title: '탭 1 — 설교 구성',
        items: [
          '설교 제목과 성경 본문을 입력합니다',
          '구조 선택: "서론 / 본론 / 결론" 또는 "발달 / 전개 / 절정 / 결말" 두 가지 중 선택',
          '각 섹션에 소제목과 본문 내용을 마크다운으로 작성합니다',
          '마크다운 툴바(H1·H2·굵게·이탤릭·목록·인용 등)로 서식을 빠르게 적용할 수 있습니다',
        ],
      },
      {
        type: 'list',
        title: '탭 2 — 아이디어 스케치',
        items: [
          '자유 형식 마크다운 편집기로 아이디어를 빠르게 메모합니다',
          '마크다운 툴바로 제목·목록·인용 등 기본 서식을 지원합니다',
          '설교 준비 전 구상 단계, 성경 공부 노트 등 자유롭게 활용하세요',
        ],
      },
      {
        type: 'step',
        title: '저장소 저장 & 불러오기',
        steps: [
          '하단 "💾 저장소에 저장" 버튼 클릭 → 오른쪽 저장소 패널에 ✍️ 아이콘으로 항목 추가',
          '저장소에서 ✍️ 항목 더블클릭 → 문서 작성 패널이 열리며 내용 자동 복원',
          '불러온 문서 수정 후 다시 "저장소에 저장" → 같은 항목에 덮어쓰기',
          '저장된 상태에서는 패널 상단에 "저장됨" 뱃지가 표시됩니다',
        ],
      },
      {
        type: 'list',
        title: '파일 내보내기',
        items: [
          '⬇ Markdown (.md) — 마크다운 파일로 다운로드',
          '⬇ Word (.docx) — Microsoft Word 파일로 다운로드',
        ],
      },
      {
        type: 'tip',
        text: '문서 작성 패널은 데스크톱 전용입니다. 작성한 문서는 저장소(localStorage)에 보관되므로, 정기적으로 .md 또는 .docx 파일로 내보내 백업해 두세요.',
      },
    ],
  },
  {
