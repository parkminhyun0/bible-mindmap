...
const SECTIONS = [
    ...
    content: [
      {
        ...
        steps: [
          ...
          '역본(개역한글 · WEB · 원어, 구약은 LXX 칠십인역 추가) 선택',
          '"검색" 클릭 — 본문이 미리보기로 표시됨',
      ...
      {
        type: 'tip',
        text: '검색 시 개역한글·WEB·원어 세 역본이 동시에 미리 로드됩니다. 노드 추가 후 즉시 어느 탭이든 딜레이 없이 전환할 수 있습니다.',
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          '개역한글 — 한국어 개역한글판',
          'WEB — World English Bible (퍼블릭 도메인 · 저작권 free)',
          'LXX — 칠십인역 (Rahlfs 1935 · 퍼블릭 도메인) · 구약 39권 전용',
  ...
  },
  {
    ...
    content: [
      {
        type: 'desc',
        text: '오른쪽 사이드바의 🔍 원어 성경 다언어 검색 버튼을 클릭하면 전체화면 검색 팝업이 열립니다. 히브리어·헬라어 원문, 영어 글로스(Gloss), 한글 KRV 세 가지 모드로 성경 전체를 검색하고, 원문·WEB·KRV 본문을 동시에 확인할 수 있습니다.',
      },
      {
        type: 'image',
      ...
      },
      {
        ...
        items: [
          '[원문] 탭: 히브리어(WLC)·헬라어(STEPBible TAGNT · CC BY 4.0) 본문, 검색어 하이라이트',
          '[영어] 탭: WEB 영어 본문, 검색어 하이라이트',
      ...
      {
        type: 'tip',
        text: '원문·영어로 검색하면 단어 단위 결과가 나오며, 원문·WEB·KRV 본문이 자동으로 함께 파생됩니다. 한글로 검색하면 KRV 절 단위 결과가 나오고 해당 절의 원어 단어가 역으로 파생됩니다.',
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: 'desc',
        text: '🎓 문맥 성경 학습 스캐폴딩 — 66권 인덱스 바로 아래 접이식 스트립("🎓 학습 스캐폴딩")으로 가이드 코스 12개 · 연구 렌즈 8종 · 활성 장 관찰 카드 35개 · 학술 용어 20 툴팁이 함께 제공됩니다. "무엇을 어떤 순서로 봐야 하는가"가 문맥 성경 UI(좌측 담화 마커 → 우측 담화 카드 → 핵심어 종단 추적 → Arc → 관주 🔗) 위에서 직접 안내됩니다.',
      },
      {
        type: 'list',
        title: '가이드 학습 코스 12종 (책·장 단위)',
        items: [
          '입문 4 · 25분 — 창 1 창조 담화 리듬 · 룻 1 언약적 결단 · 막 1 복음의 시작 · 요 1 서문의 반향',
          '중급 5 · 30-40분 — 창 22 아케다 시험 · 시 22 탄식→소망 구조 · 롬 1 주제 선포 · 롬 8 성령·확신 절정 · 히 1 시편 재사용 프롤로그',
          '고급 3 · 45-60분 — 창세기 톨레도트 종단(2:4·5:1·6:9·10:1·11:10·11:27·25:12·25:19·36:1·37:2) · 이사야 40-55 위로 노래 흐름 · 계 4-5 하늘 보좌 예배',
          '코스 클릭 시 책·장·집중 절이 자동 로드되고, 스텝별 targetVerse 를 클릭하면 활성 절도 자동 이동',
        ],
      },
      {
        type: 'list',
        title: '연구 렌즈 8종 (문맥 성경 전용)',
        items: [
          '🌊 담화 흐름 렌즈 (입문) — 원어 접속사·정형구로 논리 접속 추적 (좌측 마커 + 우측 담화 카드)',
          '🔤 핵심어 렌즈 (입문) — 반복 어휘 종단 추적, 신학 핵심어 칩 + 장 전체 분포',
          '🗺️ 거시구조 렌즈 (중급) — 좌측 Arc · pivot · 4대 섹션으로 책 전체 그림',
          '📜 장르·수사 렌즈 (중급) — 서사·시가·율법·서신·묵시별 읽기 규칙',
          '🔡 원어 형태론 렌즈 (고급) — 헤더 [히]/[헬] 절 번호 병기 + 시제·태·상·격의 신학적 무게',
          '✝️ 신학 주제 렌즈 (중급) — 언약·왕권·성전·심판·구속 흐름 추적',
          '🏛️ 배경·문화 렌즈 (입문) — 우측 배경 메타 카드(저자·연도·1차 청중·정황)',
          '🔗 관주 계보 렌즈 (중급) — 관주 🔗 votes로 상호 참조의 신학적 계보',
        ],
      },
      {
        type: 'desc',
        text: '📖 활성 장 관찰 카드 — 현재 열려있는 책·장이 코스 데이터에 등록되어 있으면 자동으로 카드가 표시됩니다. 관찰 3가지 + 담화 마커 신호(원어 단어·역할·예시) + 신학적 함의 3가지 + 다음 장 예고 구조. 35개 장이 커버되며 12개 코스 진행 중에 이 카드가 관찰의 프롬프트 역할을 합니다.',
      },
      {
        type: 'step',
        title: '심화 연구 워크플로우 (25분 예시 · 담화 흐름 렌즈 · 창세기 1장)',
        steps: [
          '📖 문맥 성경 열기 → "🎓 학습 스캐폴딩" 스트립에서 "창세기 1장 · 창조 담화 리듬" 코스 클릭',
          '자동으로 창세기 이동 + 1:1 절 활성화 + 담화 흐름 렌즈 · 핵심어 렌즈 추천 ★ 표시',
          '스텝 ①(1절 서두) 클릭 → 좌측 담화 마커 시작 신호 · 우측 담화 카드에서 בְּרֵאשִׁית 원어 확인',
          '스텝 ②(3절 핵심어) → 하단 신학 핵심어 칩에서 "엘로힘" 클릭 → 1장 26회 분포 확인 → 권 전체 종단 추적',
          '스텝 ③(5절 야심 리듬) → 방향키 ↓로 8·13·19·23·31절 훑기 → "저녁이 되고 아침이 되니" 정형구 6회 관찰',
          '스텝 ④(26절 절정) → 활성 장 카드의 "신학적 함의"와 자기 관찰 대조 → 관찰 노트 3문장 정리',
        ],
      },
      {
        type: 'tip',
        text: '학술 용어 툴팁: 렌즈·코스·카드 텍스트의 톨레도트·아케다·미슈파트·헤세드·고엘·이신칭의·페리코페 등 20개 문맥 성경 특화 용어에 자동으로 점선 밑줄이 붙습니다. 병렬 연구의 30개 용어와 통합되어 총 50개 용어가 상호 공유됩니다.',
      },
      {
        type: 'tip',
        text: '온보딩 최초 실행 + 언제든 재실행: 처음 문맥 성경을 열면 3단계 코치마크(66권 인덱스 → 가이드 코스 → 연구 렌즈)가 자동 표시됩니다. 그 이후에도 상단 "🎓 학습 스캐폴딩" 스트립 우측의 "🎓 안내" 버튼을 누르면 언제든 다시 볼 수 있습니다.',
      },
      {
        type: 'tip',
        text: 'curated 관찰과 자동 결론 구분: 코스의 학습 목표·스텝 프롬프트·활성 장 카드는 사람이 큐레이팅한 관찰 유도이며 절대적 결론이 아닙니다. "관찰된 신호 → 문학적/신학적 기능 → 정경적 함의" 세 단계로 나누어 노트하는 훈련이 문맥 성경 학습 스캐폴딩의 핵심입니다.',
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          '기준 본문 + 비교 본문 최대 4개를 나란히 배치 · KRV / WEB / 원어(SBLGNT·OSHB) 3개 탭 동시 지원',
      ...
      },
      {
        ...
        steps: [
          ...
          '③ 상단 번역 탭(개역한글·WEB·원어)에서 비교 언어 선택 → 색 표시로 차이 즉시 확인',
      ...
      {
        type: 'tip',
        text: '온보딩 재실행: 병렬 연구 팝업의 헤더 우측(닫기 × 왼쪽)에 있는 "🎓 안내" 버튼을 누르면 3단계 온보딩 코치마크(기준 본문 → 비교 본문 → 연구 렌즈)를 언제든 다시 볼 수 있습니다.',
      },
    ],
  },
  {
