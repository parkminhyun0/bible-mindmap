...
export const RUTH_CTX = {
  ...
  meta: {
    genre: '구약 서사 · 성문서',
    genreNote: '칠칠절 낭독 두루마리',
    year: '사사시대 배경 (BC 12-11세기)',
    yearNote: '편집은 왕정 시대 이후',
    place: '유다 베들레헴 · 모압',
    placeNote: '이야기 배경 (저작 장소 미상)',
    author: '익명',
    authorNote: '전승은 사무엘 · 다윗 조상 관점',
    audience: '이스라엘 공동체',
    audienceNote: '다윗 조상 이야기 · 이방 여인의 신앙 편입',
...
export const GEN_CTX = {
  ...
  meta: {
    ...
    genreNote: '토라(תּוֹרָה) 첫 권 · 창조부터 이스라엘의 애굽 정착까지',
    year: 'BC 15세기 (전통)',
    yearNote: '사건 배경: 태초 ~ BC 1876년경',
    place: '시내 광야 (전통)',
    placeNote: '기록 시점의 광야 여정',
    author: '모세 (전통)',
    authorNote: '모세오경의 첫 번째 책',
    audience: '이스라엘 백성',
    audienceNote: '출애굽 세대의 정체성 · 언약 백성의 뿌리',
...
export const EXO_CTX = {
  ...
  meta: {
    ...
    genreNote: '토라(תּוֹרָה) 둘째 · 출애굽·시내언약·성막 건축',
    year: 'BC 15세기 (전통)',
    yearNote: '출애굽 사건 · BC 1446년경',
    place: '시내 광야 (전통)',
    placeNote: '출애굽·광야 여정 기록',
    author: '모세 (전통)',
    authorNote: '모세오경 둘째 책',
    audience: '이스라엘 백성',
    audienceNote: '출애굽 세대의 정체성·언약·법 근간',
...
export const MRK_CTX = {
  ...
  meta: {
    genre: '신약 복음서 · 공관복음',
    genreNote: '4복음서 중 최초 기록 · 가장 짧고 간결',
    year: 'AD 65-70년경',
    yearNote: '네로 박해 · 성전 파괴 직전',
    place: '로마 (전통)',
    placeNote: '베드로의 설교 기록 (파피아스 전승)',
    author: '마가 요한',
    authorNote: '베드로의 통역자 · 바울과 동행',
    audience: '로마 교회 이방 그리스도인',
    audienceNote: '박해 상황 · 예수의 고난·인내 강조',
    theme: '하나님의 아들 예수 그리스도 (υἱὸς θεοῦ)',
    themeNote: '정체 계시·메시아 비밀·십자가 신학',
    chapterAgenda: {
      1:  '세례요한·예수 세례·광야 시험·갈릴리 사역',
      ...
      11: '예루살렘 입성·성전 정화·무화과 저주',
      12: '악한 소작농·가이사·부활·큰 계명·과부의 두 렙돈',
      13: '성전 파괴 예언·인자 재림·깨어 있으라',
...
export const MAT_CTX = {
  ...
  meta: {
    ...
    genreNote: 'NT 첫 책 · 다섯 담론 구조',
    year: 'AD 80-90년경',
    yearNote: '성전 파괴 후 · 유대-기독 갈등 반영',
    place: '안디옥 (전통)',
    placeNote: '시리아 유대인 공동체',
    author: '마태 (세리 레위)',
    authorNote: '12제자 중 하나 · 파피아스 전승',
    audience: '유대인 그리스도인 공동체',
    audienceNote: '구약 인용 60회+ · 성취 공식 · 하늘나라',
    theme: '왕이신 예수 · 임마누엘 · 새 모세 · 교회',
    themeNote: '다윗의 자손 → 대위임 · 왕국·성취·교회론',
    chapterAgenda: {
      1:  '예수 계보·임마누엘 탄생',
      2:  '동방박사·이집트 피난·베들레헴 학살',
      3:  '세례요한·예수 세례·하늘 음성',
      4:  '광야 40일 시험·첫 제자 부르심',
      5:  '산상수훈 ① · 팔복·소금과 빛·6대 대조',
      6:  '산상수훈 ② · 주기도문·재물·염려',
      7:  '산상수훈 ③ · 좁은 문·거짓 선지자·반석',
      8:  '이적 ① · 나병·백부장·풍랑 잠재움',
      9:  '이적 ② · 중풍병자·마태 부르심·야이로 딸',
      10: '12제자 파송 담론 · 박해 예고·성령 도움',
      11: '세례요한 질문·회개 없는 도시·쉼의 부르심',
      12: '안식일·바알세불·요나 표적·참된 가족',
      13: '천국 비유 담론 · 씨·가라지·겨자씨·진주·그물',
      14: '세례요한 순교·오병이어·물 위 걸으심',
      15: '장로 전통·가나안 여인·칠병이어',
      16: '베드로 고백·교회 반석·첫 수난 예고',
      17: '변화산·둘째 수난 예고·성전세',
      18: '교회 담론 · 잃은 양·권징 절차·용서',
      19: '이혼 논쟁·어린이 축복·부자 청년',
      20: '포도원 품꾼·셋째 수난 예고·요한·야고보 청탁',
      21: '예루살렘 입성·성전 정화·악한 소작농',
      22: '왕의 잔치·가이사 세금·부활 논쟁·큰 계명',
      23: '바리새인 화 있을진저 7번·예루살렘 애가',
      24: '종말 담론 ① · 성전 파괴·환난·인자 재림',
      25: '종말 담론 ② · 열 처녀·달란트·양과 염소',
      26: '유월절 성찬·겟세마네·체포·베드로 부인',
      27: '유다 자살·십자가·성전 휘장·백부장 고백',
      28: '부활·갈릴리 재회·대위임',
    },
  },
  macro: {
...
export const LUK_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 복음서 · 공관복음 (이방인 대상)',
    genreNote: '누가-행전 이중 저작 제1권 · 정교한 헬라어 서문',
    year: 'AD 80-85년경',
    yearNote: '성전 파괴 후 · 사도행전과 짝',
    place: '안디옥 (전통)',
    placeNote: '헬라어권 이방 도시',
    author: '누가 (Λουκᾶς)',
    authorNote: '바울의 동역자 · 이방인 의사',
    audience: '이방인 그리스도인 · 데오빌로',
    audienceNote: '"각하 데오빌로" · 헬라어권 교양층 · 만민 구원',
    theme: '이방인 구주 예수 · 성령·기도·여성·가난한 자',
    themeNote: '나사렛 선언 → 잃은 자 찾음 → 만민 죄사함',
    chapterAgenda: {
      1:  '서문·수태고지 2회·마그니피카트·세례요한 탄생',
      2:  '예수 탄생·글로리아·시므온·안나·소년 예수 성전',
      3:  '세례요한 사역·예수 세례·족보',
      4:  '광야 시험·나사렛 선언·가버나움 사역',
      5:  '베드로 배 부르심·나병·중풍·레위 부르심·금식 논쟁',
      6:  '안식일 논쟁·12제자 임명·평지 설교 (원수 사랑)',
      7:  '백부장 종·나인 과부 아들·요한 사자·죄녀 향유',
      8:  '후원 여성·씨 뿌리는 비유·풍랑·군대귀신·야이로 딸',
      9:  '12제자 파송·오병이어·베드로 고백·변화산·예루살렘 향발',
      10: '70인 파송·선한 사마리아인·마르다와 마리아',
      11: '주기도문·바알세불·요나 표적·화 있을진저',
      12: '어리석은 부자·염려·재림 준비·시대 분별',
      13: '실로암 회개·굽은 여인·좁은 문·예루살렘 애가',
      14: '잔치 자리·큰 잔치 비유·제자도 대가',
      15: '잃은 양·잃은 드라크마·탕자 (삼중 회개)',
      16: '불의한 청지기·부자와 나사로',
      17: '용서·믿음·열 문둥이·인자 임함',
      18: '과부와 재판관·바리새인과 세리·부자 관원·여리고 소경',
      19: '삭개오·므나 비유·예루살렘 입성·성전 정화',
      20: '권위 논쟁·포도원 소작인·가이사 세금·부활 논쟁',
      21: '과부 두 렙돈·성전 파괴·종말 담론·인자 재림',
      22: '유월절 성찬·감람산 기도·체포·베드로 부인',
      23: '빌라도·바라바·십자가·낙원 약속·백부장 고백',
      24: '빈 무덤·엠마오 두 제자·나타나심·승천',
    },
  },
  macro: {
    sections: [
...
export const JHN_CTX = {
  ...
  meta: {
    genre: '신약 복음서 · 제4복음서',
    genreNote: '고 기독론 · 로고스 신학 · 표적서+영광서 구조',
    year: 'AD 85-95년경',
    yearNote: '요한 서신·계시록과 함께 마지막 기록',
    place: '에베소 (전통)',
    placeNote: '요한 사도가 에베소 교회에서 기록',
    author: '요한 사도',
    authorNote: '예수의 사랑하시는 제자 · 목격 증인',
    audience: '헬라어권 그리스도인',
    audienceNote: '"믿게 하려" (20:31) · 이방인 포함',
    theme: '예수는 하나님의 아들 그리스도 · 로고스 성육신 · 영원한 생명',
    themeNote: '프롤로그 신성 → 도마 고백 · 표적 → 믿음 → 영생 (20:31)',
    chapterAgenda: {
      1:  '프롤로그 로고스·세례요한 증언·첫 제자 부르심',
      2:  '가나 첫 표적·성전 정화',
      3:  '니고데모·위로부터 남·세례요한 마지막 증언',
      4:  '사마리아 여인·영과 진리·왕의 신하 아들 표적 2',
      5:  '38년 병자 표적 3·안식일 논쟁·네 증인',
      6:  '오병이어 표적 4·물 위 걸으심 5·생명의 떡 I AM 1',
      7:  '초막절·생수의 강 약속·유대인 분쟁',
      8:  '간음한 여인·세상의 빛 I AM 2·아브라함 전 내가 있다',
      9:  '태생 소경 표적 6·유대인 심문·영적 소경 대조',
      10: '선한 목자 I AM 3·4·나와 아버지 하나·수전절',
      11: '나사로 부활 표적 7·부활이요 생명 I AM 5·산헤드린 결의',
      12: '마리아 향유·예루살렘 입성·인자 영광의 때',
      13: '발 씻김·유다 지목·새 계명·베드로 부인 예고',
      14: '길·진리·생명 I AM 6·첫 보혜사 약속·내 평강',
      15: '참 포도나무 I AM 7·서로 사랑·성령 증언',
      16: '보혜사 재차 약속·잠시 후·세상 이김',
      17: '대사장 기도·자신 영광·제자 보호·하나 됨',
      18: '동산 체포·안나스·가야바·베드로 부인·빌라도',
      19: '십자가·어머니 위탁·다 이루었다·창 찔림',
      20: '부활·막달라 마리아·도마 고백·책의 목적',
      21: '갈릴리 재현·153 물고기·베드로 회복 3중',
    },
  },
  macro: {
    sections: [
...
export const ACT_CTX = {
  ...
  meta: {
    genre: '신약 서사 · 누가행전 제2권',
    genreNote: '고대 역사·전기 · 케리그마 설교 8편 삽입',
    year: 'AD 80년경',
    yearNote: '예루살렘 파괴 이후',
    place: '로마 (전통)',
    placeNote: '누가가 바울 동역자로 기록',
    author: '누가',
    authorNote: '이방인 의사 · 바울 동역자',
    audience: '데오빌로 및 헬라어권 이방 그리스도인',
    audienceNote: '이방 기독교 · 로마 제국 문맥',
    theme: '성령의 능력으로 예루살렘에서 땅끝까지',
    themeNote: '1:8 지리 프로그램 → 28:31 로마 성취 · 유대→이방 확장',
    chapterAgenda: {
      1:  '이중 서문·부활 후 40일·지리 프로그램·승천·마티아 선정',
      2:  '오순절 성령·방언·베드로 첫 설교·3천 명·초대교회 공동체',
      3:  '미문 앉은뱅이 치유·베드로 둘째 설교',
      4:  '산헤드린 심문·다른 이름 없음·초대교회 나눔',
      5:  '아나니아·삽비라·사도 표적·가말리엘·채찍질 기뻐함',
      6:  '일곱 집사·말씀 왕성 요약·스데반 논쟁',
      7:  '스데반 설교·구속사 개관·첫 순교',
      8:  '큰 박해·흩어진 자 전파·빌립·사마리아·에디오피아 내시',
      9:  '사울 다메섹 회심·택한 그릇·평안 요약',
      10: '고넬료·베드로 환상·이방인 오순절·외모 취하지 아니하심',
      11: '이방 사역 보고·안디옥 교회·"그리스도인" 첫 호칭',
      12: '야고보 순교·베드로 천사 구원·헤롯 죽음·말씀 흥왕',
      13: '성령 파송·1차 선교·비시디아 안디옥 설교·이방의 빛',
      14: '이고니온·루스드라·더베·1차 선교 마감',
      15: '예루살렘 공의회·은혜 구원·성령과 우리·바나바 결별',
      16: '2차 선교·디모데·마게도냐 환상·빌립보 간수 회심',
      17: '데살로니가·베뢰아·아덴 아레오바고 설교',
      18: '고린도 1년 반·아굴라·브리스길라·갈리오·아볼로',
      19: '에베소 3년·기적·스게와 아들·아데미 소요·말씀 흥왕',
      20: '드로아 유두고 부활·밀레도 장로 고별·자기 피로 사신 교회',
      21: '예루살렘 여행·아가보 예언·성전 소요·바울 체포',
      22: '히브리어 자기 변호·회심 2차 증언·이방인 파송 재소환',
      23: '산헤드린 부활 쟁점·40인 음모·가이사랴 이송',
      24: '벨릭스 심문·이 도를 따라·2년 감금',
      25: '베스도·카이사르 상소·아그립바 방문',
      26: '아그립바 앞 회심 3차·눈 뜨게·어둠에서 빛으로',
      27: '로마行·유라굴로·14일 표류·몰타 파선·모두 구원',
      28: '몰타 3개월·로마 도착·이방인에게·담대히 하나님 나라',
    },
  },
  macro: {
    sections: [
...
export const LEV_CTX = {
  ...
  theoTerms: HEBREW_OT_THEO_TERMS,
  meta: {
    genre: '구약 오경 (Torah) · 예배·거룩 규범',
    genreNote: '오경 중심 위치 · 규범 위주',
    year: 'BC 15세기 (전통)',
    yearNote: '출애굽 2년째 시내산 계시',
    place: '시내산 회막',
    placeNote: '레위기 전체가 회막 계시 (1:1)',
    author: '모세 (전통)',
    authorNote: '모세오경 셋째 책',
    audience: '광야 이스라엘 · 제사장·백성',
    audienceNote: '제사장 실무 규범 + 백성 거룩 훈련 · "와이크라"',
    theme: '거룩·속죄·임재 · 여호와께 가까이 나아감',
    themeNote: '제사·정결·거룩 · "나는 거룩하니 너희도 거룩할지어다"',
    chapterAgenda: {
      1:  '번제 (עֹלָה) 규례',
      2:  '소제 (מִנְחָה) 규례',
      3:  '화목제 (שְׁלָמִים) 규례',
      4:  '속죄제 (חַטָּאת) 규례',
      5:  '속건제 (אָשָׁם) 규례',
      6:  '번제·소제·속죄제 추가·제사장 몫',
      7:  '속건제·화목제 마무리·피·기름 금지',
      8:  '아론과 아들들 위임식',
      9:  '위임 8일째 첫 제사·여호와의 영광·제단 불',
      10: '나답과 아비후 다른 불·제사장 삶 규례',
      11: '음식법·정결/부정한 짐승',
      12: '산모 정결례',
      13: '나병 진단 규례',
      14: '나병자·나병 든 집 정결례',
      15: '유출병 정결',
      16: '대속죄일·지성소·두 염소·아사셀',
      17: '피 규례·육체 생명은 피에·우상 제사 금지',
      18: '성적 부정 금지·애굽·가나안 관습 배격',
      19: '거룩성 법전 정점·이웃 사랑·이방인 사랑',
      20: '형벌 규정·스스로 거룩하게',
      21: '제사장 거룩 규례·흠 있는 제사장',
      22: '성물 규례·흠 있는 제물 금지',
      23: '여호와의 절기 7종',
      24: '성막 등불·진설병·신성모독 처벌',
      25: '안식년·희년 (יוֹבֵל)·땅은 하나님 것',
      26: '순종의 축복·불순종의 저주·언약 기억',
      27: '서원·십일조 규례·결론',
    },
  },
  macro: {
...
export const GAL_CTX = {
  ...
  meta: {
    ...
    genreNote: '논쟁적 서신 · 감사 부분 생략',
    year: 'AD 48-49년경',
    yearNote: '예루살렘 공의회 이전 · 바울 초기',
    place: '안디옥 (전통)',
    placeNote: '1차 선교여행 직후',
    author: '사도 바울',
    authorNote: '친필 서명 (6:11 큰 글자)',
    audience: '갈라디아 지역 교회들',
    audienceNote: '유대주의자 침투 · 할례 강요',
    theme: '이신칭의 · 성령의 자유 · 율법에서 해방 · 새 창조',
    themeNote: '이신칭의 (2:16) · 자유 (5:1) · 성령 · 새 창조 4중 축',
    chapterAgenda: {
      1: '서문·다른 복음 저주·사도직 변호·아라비아·다메섹',
      2: '예루살렘 방문·안디옥 사건·이신칭의 정식·그리스도와 함께 십자가',
      3: '어리석도다 갈라디아·성령 vs 율법·아브라함 믿음·율법의 저주 대속',
      4: '때가 차매 아들 보내심·양자·압바 아버지·사라·하갈 알레고리',
      5: '자유 마그나 카르타·사랑으로 역사하는 믿음·성령의 열매 9가지',
      6: '짐 서로 지라·자랑할 것은 십자가·새 창조·예수의 흔적',
    },
  },
  macro: {
    sections: [
...
export const EPH_CTX = {
  ...
  meta: {
    genre: '신약 서신 · 옥중서신',
    genreNote: '예전·찬송 요소 다수 · 회람 서신 가능성',
    year: 'AD 60-62년경',
    yearNote: '로마 감금기',
    place: '로마 감금',
    placeNote: '두기고가 골로새·에베소 동시 전달',
    author: '사도 바울',
    authorNote: '옥중서신 그룹',
    audience: '에베소 교회 및 소아시아 이방 기독교',
    audienceNote: '이방 기독교 정체성 확립',
    theme: '그리스도 안에서 · 교회의 신비 · 유대·이방 하나',
    themeNote: '1-3장 교리 → 4-6장 실천 · "그리스도 안에서" 34회',
    chapterAgenda: {
      1: '인사·삼위 찬송·성부 택하심·성자 속량·성령 인침·교회 머리',
      2: '허물로 죽은 자·함께 살리심·은혜 믿음 구원·유대·이방 하나',
      3: '이방인 신비 계시·함께 상속자·바울 기도·사랑 4차원',
      4: '몸의 하나됨·사역자 5직·옛 사람 벗음·새 사람 입음',
      5: '사랑 가운데 행함·빛의 자녀·성령 충만·부부론',
      6: '자녀·부모·종·상전·전신갑주·영적 전쟁·마지막 인사',
    },
  },
  macro: {
    sections: [
...
export const PHIL_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 서신 · 옥중서신 · 우정 서신',
    genreNote: '교제·감사 중심 · 헬레니즘 우정 서신 형식',
    year: 'AD 60-62년경',
    yearNote: '로마 감금기',
    place: '로마 감금',
    placeNote: '근위대(1:13)·가이사 집 사람(4:22)',
    author: '사도 바울',
    authorNote: '디모데 공동 발신자',
    audience: '빌립보 교회',
    audienceNote: '마게도냐 최초 유럽 교회 · 헌금 감사 답신',
    theme: '주 안에서 항상 기뻐하라 · 그리스도의 마음 · 하늘 시민권',
    themeNote: '그리스도 찬가(2:5-11)가 신학 중심 · 기쁨 16회',
    chapterAgenda: {
      1: '인사·감사·바울 매임 = 복음 진보·사는 것이 그리스도·시민권 동사',
      2: '같은 마음·그리스도 찬가 κένωσις·ὑπερύψωσεν·두렵고 떨림 구원',
      3: '배설물(σκύβαλα)로 여김·부활 능력·푯대 향해·시민권 하늘',
      4: '유오디아·순두게·항상 기뻐하라·하나님의 평강·자족·헌금 감사',
    },
  },
  macro: {
    sections: [
...
export const COL_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 서신 · 옥중서신 · 이단 논박',
    genreNote: '에베소·빌레몬과 동시 전달 · 엡과 병행 어휘 55%',
    year: 'AD 60-62년경',
    yearNote: '로마 감금기',
    place: '로마 감금',
    placeNote: '두기고+오네시모 전달',
    author: '사도 바울',
    authorNote: '옥중서신 그룹',
    audience: '골로새 교회',
    audienceNote: '에바브라 개척 · 리쿠스 계곡 이방인 다수',
    theme: '그리스도의 우선성·충족성 · 창조·유지·화해·머리',
    themeNote: '골로새 이단(유대·신비주의·금욕 혼합) → 그리스도 πλήρωμα로 논박',
    chapterAgenda: {
      1: '인사·감사·기도·그리스도 찬가·너희 안에 그리스도 영광의 소망',
      2: '지혜의 보화·헛된 철학·신성 충만 육체로·개선식 승리·그림자 조심',
      3: '위의 것 찾으라·감추어진 생명·새 사람·그리스도 만유·가정 규칙',
      4: '기도·소금으로 말·두기고·오네시모·라오디게아 서신 교환·마지막 인사',
    },
  },
  macro: {
    sections: [
...
export const THESS1_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 서신 · 바울 최초 서신 · 목회 격려·재림 교리',
    genreNote: '신약 최초기 문서 · 파루시아 신학',
    year: 'AD 50-51년경',
    yearNote: '2차 선교여행 중 · 신약 최초기',
    place: '고린도',
    placeNote: '2차 선교여행 · 아가야',
    author: '사도 바울',
    authorNote: '실루아노·디모데 공동 발신자',
    audience: '데살로니가 교회',
    audienceNote: '젊은 이방인 교회 · 재림 오해 (죽은 성도 걱정)',
    theme: '재림(파루시아) 위로 · 감사·본받음 · 성화',
    themeNote: '파루시아 4회 각 장 마감 · 종말 두 축(4:13-18·5:1-11)',
    chapterAgenda: {
      1: '인사·감사 1·믿음·소망·사랑 3중·본받은 자·아들 기다림',
      2: '바울 사역 회상·유모·아버지 목양·말씀 받음·소망 면류관 (파루시아 1)',
      3: '디모데 파송·믿음 견고 소식·감사 3·마음 굳게 (파루시아 2)',
      4: '하나님의 뜻 = 거룩·형제 사랑·손으로 일함·공중 만남 (파루시아 3)',
      5: '주의 날 도둑같이·빛의 아들·호심경·투구·항상 기뻐·쉬지 말고 기도 (파루시아 4)',
    },
  },
  macro: {
    sections: [
...
export const THESS2_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 서신 · 재림 신학 정정 (살전 쌍둥이)',
    genreNote: '살전 병행 구조 + 종말 정정(2:1-12) 삽입',
    year: 'AD 50-52년경',
    yearNote: '살전 직후',
    place: '고린도',
    placeNote: '살전과 동일',
    author: '사도 바울',
    authorNote: '실루아노·디모데 공동 발신자 · 친필 서명(3:17)',
    audience: '데살로니가 교회',
    audienceNote: '재림 임박 오해 확산 · 위조 편지 유통 · 게으름 심화',
    theme: '주의 날 오해 정정 · 불법의 사람·저지자',
    themeNote: '종말 순서 계시(배교→불법자→주 파루시아) · 친필 = 위조 방지',
    chapterAgenda: {
      1: '인사·감사 "마땅함이라"·환난 인내·주 강림 불꽃 중에·형벌·영광',
      2: '주의 날 이미 X·배교·불법의 사람·저지자·사탄 파루시아·전통 굳게',
      3: '기도·주는 미쁘사·게으른 형제 훈계·일 안 하면 먹지 말게·친필 서명',
    },
  },
  macro: {
    sections: [
...
export const PHLM_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 서신 · 개인 서신 · 신약 최단 서신 (25절)',
    genreNote: '중재 편지 · 오네시모 서사',
    year: 'AD 60-62년경',
    yearNote: '로마 감금기 · 골로새서와 동시',
    place: '로마 감금',
    placeNote: '두기고+오네시모 파송',
    author: '사도 바울',
    authorNote: '디모데 공동 발신자 · 친필 서명(19절)',
    audience: '빌레몬 (골로새 교회 신자·오네시모의 주인)',
    audienceNote: '오네시모(Ὀνήσιμος "유익") = 도망한 종·회심 후 돌려보냄',
    theme: '그리스도 안에서 새로운 관계 · 노예 → 사랑받는 형제',
    themeNote: '노예제 신학적 재정의(16절) · 대속 축소판(18-19절)',
    chapterAgenda: {
      1: '매인 자 인사·감사·심장 시원·오네시모 간청·무익→유익·종 이상 사랑받는 형제·내게 돌리라 친필 서명·결론',
    },
  },
  macro: {
    sections: [
...
export const TIM1_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 서신 · 목회서신 (딤전·딤후·딛)',
    genreNote: '교회 조직 매뉴얼 · 개인 편지 형식',
    year: 'AD 63-65년경',
    yearNote: '로마 1차 감금 석방 후',
    place: '마게도냐',
    placeNote: '디모데를 에베소에 남기고 이동 중',
    author: '사도 바울',
    authorNote: '디모데에게 보낸 첫 편지',
    audience: '디모데 (에베소 교회 목회자)',
    audienceNote: '젊은 목회자 · 바울의 영적 아들',
    theme: '교회 조직 · 감독·집사 자격 · 경건의 신비 · 자족',
    themeNote: '"미쁘다 이 말이여" 5회 · 진리의 기둥과 터',
    chapterAgenda: {
      1: '인사·거짓 교사 논박·죄인 중 괴수·선한 싸움 위탁·후메내오·알렉산더',
      2: '만인 위한 기도·한 중보자·대속물·여자 교훈 논쟁',
      3: '감독 자격·집사 자격·진리의 기둥과 터·경건의 비밀 6행 찬송',
      4: '후일 배도·연소함 업신여김 X·본이 되어·낭독·권면·가르침·안수',
      5: '노인·젊은이 대함·과부 명부·장로 배나 존경·안수 신중',
      6: '종·상전·돈 사랑 = 일만 악의 뿌리·6덕목 따르라·믿음의 선한 싸움·만왕의 왕',
    },
  },
  macro: {
    sections: [
...
export const TIM2_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 서신 · 목회서신 · 바울 최후 유서',
    genreNote: '유언 형식 · 순교 직전 마지막 편지',
    year: 'AD 66-67년경',
    yearNote: '로마 2차 감금 · 네로 박해 순교 직전',
    place: '로마 지하 감옥',
    placeNote: '오네시보로가 찾아 만남(1:17)',
    author: '사도 바울',
    authorNote: '순교 직전 · 개인 편지 성격 강함',
    audience: '디모데 (에베소 목회자)',
    audienceNote: '바울 사랑하는 아들 · 로마로 속히 오라 부름',
    theme: '바울 유서 · 순교 각오 · 정통 계승 · 성경 영감',
    themeNote: '4:6-8 삼중 정식(선한 싸움·달려갈 길·믿음 지킴) → 의의 면류관 · 성경 영감 정식(3:16)',
    chapterAgenda: {
      1: '3세대 믿음·주의 증언 부끄러워 X·부탁한 것 지키실 줄·바른 말의 본·오네시보로',
      2: '충성된 자에게 부탁·군사·경기자·농부 3중·미쁘다 이 말이여 4행·진리 옳게 분별',
      3: '말세 고통·18악 목록·얀네·얌브레·어릴 때부터 성경·성경 영감 (θεόπνευστος)',
      4: '말씀 전파·때를 얻든지·바울 유서·3중 정식·의의 면류관·개인 인사',
    },
  },
  macro: {
    sections: [
...
export const TIT_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 서신 · 목회서신 · 교회 조직 매뉴얼',
    genreNote: '딤전 짝 · 짧고 압축 · 두 신학 정식(2:11-14·3:4-7)',
    year: 'AD 63-65년경',
    yearNote: '로마 감금 후 · 그레데 파송 후 마게도냐 이동',
    place: '마게도냐',
    placeNote: '니고볼리에서 겨울 예정',
    author: '사도 바울',
    authorNote: '디도에게 보낸 편지',
    audience: '디도 (그레데 파송 목회자)',
    audienceNote: '이방인 · 갈 2:1-3 예루살렘 동행 · 그레데 이방 문화 강함',
    theme: '교회 조직 · 바른 교훈 · 은혜 초림·재림 · 세례·성령 갱신',
    themeNote: '은혜 두 나타남(2:11-14) + 세례·성령 갱신(3:4-7) · 선한 일 강조',
    chapterAgenda: {
      1: '인사·각 성에 장로 세움·거짓 교사·할례파 논박·그레데인 역설',
      2: '바른 교훈·가정 권면·은혜 두 나타남·복스러운 소망',
      3: '통치자 복종·선한 일·세례·성령 갱신·이단 훈계 후 멀리·개인 인사',
    },
  },
  macro: {
    sections: [
...
export const HEB_CTX = {
  ...
  theoTerms: ROM_THEO_TERMS,
  meta: {
    genre: '신약 · 설교·논문 서신 혼합',
    genreNote: '서신 형식이나 실제로는 설교 · "권면의 말"(13:22)',
    year: 'AD 60-70년경',
    yearNote: '성전 파괴(AD 70) 이전 유력',
    place: '로마 수신 (다수설)',
    placeNote: '"이달리야에서 온 자들"(13:24)',
    author: '미상',
    authorNote: '헬레니즘 유대인 · 후보: 아볼로·바나바·브리스길라',
    audience: '유대인 그리스도인',
    audienceNote: '유대교 회귀 유혹 · 박해 겪은 성숙 공동체 · OT 인용 최다',
    theme: '아들의 우월성 · 대제사장 기독론 · 새 언약 · 단번에 · 배교 경고',
    themeNote: '5대 경고 본문 · κρείττων 13회 우월성 축 · 시 110 기독론 근거',
    chapterAgenda: {
      1: '프롤로그·선지자 → 아들·만유 상속·창조 대리·아들이 천사보다 우월',
      2: '경고 1 · 흘러 떠내려가지 않도록·죽음 맛보심·자비하고 신실한 대제사장',
      3: '모세보다 뛰어난 아들·경고 2 · 광야 세대·오늘 · 시 95 인용',
      4: '하나님의 안식 남아 있음·말씀 양날의 검·큰 대제사장·은혜의 보좌',
      5: '대제사장 자격·순종 배움·멜기세덱 반차 도입·경고 3 시작',
      6: '경고 3 본체·타락한 자·소망의 닻·멜기세덱 반차 예수',
      7: '멜기세덱·아브라함 십일조·레위보다 우월·더 좋은 언약의 보증·단번에',
      8: '하늘 성소 대제사장·모세는 모형·새 언약 (렘 31 최장 인용)',
      9: '지상 성막·자기 피로 단번에 성소·새 언약 중보자·단번에 제사',
      10: '율법은 그림자·그리스도 몸 단번에·새 언약 재인용·경고 4',
      11: '믿음장 · 정의 · 아벨·에녹·아브라함·모세·라합·나그네·순례자',
      12: '구름 같은 증인·인내 경주·창시자·완성자 예수·아버지 징계·시온산',
      13: '형제 사랑·손님 대접·어제·오늘·영원 동일·영문 밖 예수·큰 목자',
    },
  },
  macro: {
    sections: [
