...
export const CONTEXT_CHAPTER_CARDS_PHLM = {
  'Phlm:1': C('🤝', '서신 · 복음 안의 형제됨과 자발적 화해', [
    ...
    '8-16절에서 명령할 권리보다 사랑으로 간구함·오네시모의 이전과 현재·바울의 심복·강제가 아닌 자발성·종을 넘어 사랑받는 형제로의 관계 변화가 어떻게 전개되는지 보세요.',
    ...
    { marker: 'ἀλλά (알라)', role: '권위 있는 명령과 사랑의 간구, 강제와 자발성의 대조', example: '9·14·16절' },
    ...
    '바울은 사도적 권위를 포기하지 않으면서도 강압보다 사랑과 자발적 선행을 통해 화해가 복음의 열매로 나타나게 합니다.',
