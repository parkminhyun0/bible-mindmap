...
import { KOREAN_GLOSS_TOP_BATCH_02 } from './koreanGlossTopBatch02.js';
import { KOREAN_GLOSS_TOP_BATCH_03 } from './koreanGlossTopBatch03.js';
...
export const KOREAN_GLOSS_ACTIVE_META = {
  ...
  extensionCount:
    ...
    + Object.keys(KOREAN_GLOSS_TOP_BATCH_02).length
    + Object.keys(KOREAN_GLOSS_TOP_BATCH_03).length,
};
